defmodule App.Context.CoursesTest do
  use App.DataCase

  alias App.Context.Courses

  describe "courses" do
    alias App.Schema.Course

    import App.Context.CoursesFixtures

    @invalid_attrs %{course_code: nil, name: nil}
    ...
    test "create_course/1 with valid data creates a course" do
      valid_attrs = %{course_code: "some course_code", name: "some name"}
    ...
    test "update_course/2 with valid data updates the course" do
      course = course_fixture()
      update_attrs = %{course_code: "some updated course_code", name: "some updated name"}
